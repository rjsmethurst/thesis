...
\begin{figure*}
\centering
\includegraphics[width=\textwidth]{agn/agn-host_inactive_z_mass_distributions.pdf}
\caption[Redshift and mass distributions of the \textsc{agn-host} and \textsc{inactive} samples]{Distribution of the redshifts (left) and stellar masses (right) in the \textsc{agn-host} sample (solid lines) in comparison to the matched control \textsc{inactive} sample (dashed lines).}
