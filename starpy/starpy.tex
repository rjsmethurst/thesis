...
For the likelihood function you need to think about what hypothesis (or model, $\theta$) best describes your problem. In this case you might choose a Bernouilli likelihood distribution, e.g. 
